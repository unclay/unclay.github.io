...
seajs.config({base:function(){return window.location.href.indexOf("unclay.com")>=0?"http://source.unclay.com/moe/":window.location.href.indexOf("home.com")>=0?"http://source.home.com/moe/":"http://localhost:8011/moe/"}(),paths:{},alias:{jquery:"jquery/1.8.3/jquery.js"},preload:["jquery"]}),seajs.on("exec",function(e){e.uri===seajs.resolve("jquery")&&(window.$=window.jQuery=e.exports)}),seajs.use("jquery",function(e){window.jQuery=window.$=e});